...
- Does each element have a unique class name? -> Done
- Did you use the grouping selector for styles that both elements share? -> Done, yes
- Did you make separate rules for the styles unique to each element? -> Done, yes
