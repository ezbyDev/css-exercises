...
### Self Check
- Do the odd numbered `p` elements share a class? -> Done
- Do the even numbered `div` elements have unique IDs? -> Done
- Does the Number 3 element have multiple classes? -> Done by using inline css instead 
